  var app = new Vue({
      ...
      data: {
          ...
          "maps": [],
          clubs: data.clubs,
          season_fixtures: data.season_fixtures,
      ...
      methods: {
          ...
          loginFunction() {
              ...
              firebase.auth().signInWithPopup(provider)
                  ...
                  }).then(document.getElementById("login").style.display = "none")                  .then(document.getElementById("logout").style.display = "block")
...
//          },
  ...
  var allGames = app.season_fixtures
